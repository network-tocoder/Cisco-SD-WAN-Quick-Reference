...
<p align="left" style="color:#1976d2; font-size:1.22em; font-family:'Montserrat', 'Segoe UI', 'Roboto', 'Arial', 'Helvetica Neue', sans-serif; font-weight:600; line-height:1.5;">
  <span style="background: #e3f2fd; padding: 0.2em 0.7em; border-radius: 8px;">This project focuses on sharing brief, clear explanations about Cisco SD-WAN from its technology view point & automation capabilities </span>
</p>
<p align="right">
...
<details>
  ...
  <ul>
    ...
    <li><a href="SD-WAN_Controller_Funtions.md">SD-WAN Functional Planes Overview</a></li>
    <li><a href="01_SD-WAN_Core_Concepts/Security_and_Authentication.md">Security & Transport Protocol</a></li>
    <li><a href="How_SD-WAN_works.md">How SD-WAN Works (Step by Step Flow)</a></li>
